            ...
            <div class="intro-y box">
                ...
                <div class="p-5" id="image-zoom">
                    <div class="preview">
                        <div class="leading-relaxed">
                            ...
                            <div class="w-full h-64 my-5 image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{ asset('dist/images/' . $fakers[0]['images'][0]) }}" data-action="zoom" class="w-full rounded-md">
                            </div>
                            <p class="mb-5">
                            ...
                            <div class="w-3/5 h-64 mr-6 float-left image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{ asset('dist/images/' . $fakers[0]['images'][1]) }}" data-action="zoom" class="w-full rounded-md">
                            </div>
                            <p class="mb-5">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-image-zoom" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
