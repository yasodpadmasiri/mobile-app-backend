        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="intro-y box">
                ...
                <div class="p-5" id="basic-alert">
                    <div class="preview">
                        ...
                        <div class="rounded-md px-5 py-4 mb-2 border text-gray-700 dark:text-gray-300 dark:border-dark-5">Awesome simple alert</div>
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-basic-alert" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="icon-alert">
                    <div class="preview">
                        ...
                        <div class="rounded-md flex items-center px-5 py-4 mb-2 border text-gray-700 dark:text-gray-300 dark:border-dark-5">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-icon-alert" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="additional-content-alert">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-additional-content-alert" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="intro-y box">
                ...
                <div class="p-5" id="icon-dismiss-alert">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-icon-dismiss-alert" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="outline-alert">
                    <div class="preview">
                        <div class="rounded-md flex items-center px-5 py-4 mb-2 border border-theme-1 text-theme-1 dark:text-theme-10 dark:border-theme-10">
                            <i data-feather="alert-circle" class="w-6 h-6 mr-2"></i> Awesome alert with icon <i data-feather="x" class="w-4 h-4 ml-auto"></i>
                        </div>
                        <div class="rounded-md flex items-center px-5 py-4 mb-2 border text-gray-700 dark:text-gray-300 dark:border-dark-5">
                            <i data-feather="alert-octagon" class="w-6 h-6 mr-2"></i> Awesome alert with icon <i data-feather="x" class="w-4 h-4 ml-auto"></i>
                        ...
                        <div class="rounded-md flex items-center px-5 py-4 mb-2 border border-theme-12 text-theme-12 dark:border-theme-12">
                            <i data-feather="alert-circle" class="w-6 h-6 mr-2"></i> Awesome alert with icon <i data-feather="x" class="w-4 h-4 ml-auto"></i>
                        </div>
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-outline-alert" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="softcolor-alert">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-softcolor-alert" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
