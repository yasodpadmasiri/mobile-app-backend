...
@section('subhead')
    <title>Author List - Blog</title>
@endsection

@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Author List</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <button class="button text-white bg-theme-1 shadow-md mr-2">Add New Author</button>
            <div class="dropdown">
                ...
                <tbody>
                    ...
                    @foreach (array_slice($fakers, 0, 9) as $faker)
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="" class="font-medium whitespace-no-wrap">{{ $faker['users'][0]['email'] }}</a>
                            </td>
                            <td class="w-40">
