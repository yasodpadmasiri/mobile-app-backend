        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="intro-y box">
                ...
                <div class="p-5" id="basic-accordion">
                    <div class="preview">
                        <div class="accordion">
                            <div class="accordion__pane active border-b border-gray-200 dark:border-dark-5 pb-4">
                            ...
                            <div class="accordion__pane border-b border-gray-200 dark:border-dark-5 py-4">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-basic-accordion" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="intro-y box">
                ...
                <div class="p-5" id="boxed-accordion">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-boxed-accordion" class="copy-code button button--sm border border-gray-200 dark:border-dark-5 flex items-center text-gray-700">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
