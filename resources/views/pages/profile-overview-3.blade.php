        ...
        <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                ...
                <div class="p-5">
                    ...
                    <div class="relative flex items-center mt-5">
                        <div class="w-12 h-12 flex-none image-fit">
                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('dist/images/' . $fakers[1]['photos'][0]) }}">
                        </div>
                        <div class="ml-4 mr-auto">
                    ...
                    <div class="relative flex items-center mt-5">
                        <div class="w-12 h-12 flex-none image-fit">
                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('dist/images/' . $fakers[2]['photos'][0]) }}">
                        </div>
                        <div class="ml-4 mr-auto">
            ...
            <div class="intro-y box mt-5">
                <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <button data-carousel="announcement" data-target="prev" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300 mr-2">
                        <i data-feather="chevron-left" class="w-4 h-4"></i>
                    </button>
                    <button data-carousel="announcement" data-target="next" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300">
                ...
                <div class="tiny-slider py-5" id="announcement">
                    <div class="px-5">
                        ...
                        <div class="flex items-center mt-5">
                            ...
                            <button class="button justify-center block bg-gray-200 dark:bg-dark-5 dark:text-gray-300 text-gray-600 ml-auto">View Details</button>
                        </div>
                    </div>
                    <div class="px-5">
                        <div class="font-medium text-lg">Midone Admin Template</div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <button data-carousel="projects" data-target="prev" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300 mr-2">
                        <i data-feather="chevron-left" class="w-4 h-4"></i>
                    </button>
                    <button data-carousel="projects" data-target="next" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300">
                        <i data-feather="chevron-right" class="w-4 h-4"></i>
                    </button>
                </div>
                <div class="tiny-slider py-5" id="projects">
                    <div class="px-5">
                        ...
                        <div class="mt-5">
                            <div class="flex">
                                <div class="text-gray-700 dark:text-gray-600 mr-auto">Pending Tasks</div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <button data-carousel="todays-schedule" data-target="prev" class="tiny-slider-navigator button px-2 border text-white relative flex items-center text-gray-700 dark:text-gray-300 mr-2">
                        <i data-feather="chevron-left" class="w-4 h-4"></i>
                    </button>
                    <button data-carousel="todays-schedule" data-target="next" class="tiny-slider-navigator button px-2 border text-white relative flex items-center text-gray-700 dark:text-gray-300">
                        <i data-feather="chevron-right" class="w-4 h-4"></i>
                    </button>
                </div>
                <div class="tiny-slider py-5" id="todays-schedule">
                    <div class="px-5 text-center sm:text-left">
                        <div class="font-medium">Developing rest API with Laravel 7</div>
                        <div class="text-theme-1 dark:text-theme-10 font-medium text-lg mt-2">11:15AM - 12:30PM</div>
                        <div class="flex flex-col sm:flex-row items-center mt-5">
                            ...
                            <button class="button button--sm justify-center block bg-gray-200 dark:bg-dark-5 dark:text-gray-300 text-gray-600 sm:ml-auto mt-3 sm:mt-0">View On Map</button>
                        </div>
                    </div>
                    <div class="px-5 text-center sm:text-left">
                        <div class="font-medium">Developing rest API with Laravel 7</div>
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5">
                    <div class="boxed-tabs nav-tabs justify-center flex flex-col sm:flex-row text-gray-700 dark:text-gray-300">
                        <a data-toggle="tab" data-target="#laravel" href="javascript:;" class="w-full sm:w-20 mb-2 sm:mb-0 py-2 rounded-md box dark:bg-dark-5 text-center sm:mx-2 active">
                            <i data-feather="box" class="w-6 h-6 mb-2 mx-auto"></i> Laravel
                        </a>
                        <a data-toggle="tab" data-target="#symfony" href="javascript:;" class="w-full sm:w-20 mb-2 sm:mb-0 py-2 rounded-md box dark:bg-dark-5 text-center sm:mx-2">
                            <i data-feather="inbox" class="w-6 h-6 mb-2 mx-auto"></i> Symfony
                        </a>
                        <a data-toggle="tab" data-target="#bootstrap" href="javascript:;" class="w-full sm:w-20 mb-2 sm:mb-0 py-2 rounded-md box dark:bg-dark-5 text-center sm:mx-2">
                        ...
                        <div class="tab-content__pane active" id="laravel">
                            <div class="flex flex-col sm:flex-row items-center">
                                ...
                                <div class="w-full sm:w-auto flex items-center mt-3 sm:mt-0">
                                    ...
                                    <div class="w-full sm:w-40 h-1 bg-gray-400 dark:bg-dark-1 rounded-full">
                                        <div class="w-1/2 h-full bg-theme-1 rounded-full"></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="flex items-center px-5 py-5 sm:py-0 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="dropdown ml-auto sm:hidden">
                        ...
                        <div class="nav-tabs dropdown-box w-40">
                            <div class="dropdown-box__content box dark:bg-dark-1 p-2">
                                <a href="javascript:;" data-toggle="tab" data-target="#new" class="block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">New</a>
                                <a href="javascript:;" data-toggle="tab" data-target="#last-week" class="block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">Last Week</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="dropdown ml-auto">
                        ...
                        <button class="dropdown-toggle button font-normal border dark:border-dark-5 text-white relative items-center text-gray-700 dark:text-gray-300 hidden sm:flex">
                ...
                <div class="p-5">
                    <div class="flex flex-col sm:flex-row items-center">
                        ...
                        <div class="dropdown mt-3 sm:mt-0 mr-auto sm:mr-0">
                            <button class="dropdown-toggle button font-normal border dark:border-dark-5 text-white relative flex items-center text-gray-700 dark:text-gray-300">
