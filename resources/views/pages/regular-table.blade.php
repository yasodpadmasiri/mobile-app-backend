        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <div class="p-5" id="basic-table">
                            ...
                            <table class="table mt-5">
                                <thead>
                                    <tr class="bg-gray-700 dark:bg-dark-1 text-white">
                                        <th class="border-b-2 dark:border-dark-5 border-gray-600 whitespace-no-wrap">#</th>
                                        <th class="border-b-2 dark:border-dark-5 border-gray-600 whitespace-no-wrap">First Name</th>
                                        <th class="border-b-2 dark:border-dark-5 border-gray-600 whitespace-no-wrap">Last Name</th>
                                        <th class="border-b-2 dark:border-dark-5 border-gray-600 whitespace-no-wrap">Username</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="bg-gray-700 dark:bg-dark-1 text-white">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-basic-table" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="bordered-table">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border border-b-2 dark:border-dark-5 whitespace-no-wrap">First Name</th>
                                        <th class="border border-b-2 dark:border-dark-5 whitespace-no-wrap">Last Name</th>
                                        <th class="border border-b-2 dark:border-dark-5 whitespace-no-wrap">Username</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-bordered-table" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="hoverable-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-hoverable-table" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="row-states-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-row-states-table" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <div class="p-5" id="head-options-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-head-options-table" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="responsive-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-responsive-table" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="small-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-small-table" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="striped-rows-table">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-striped-rows-table" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
