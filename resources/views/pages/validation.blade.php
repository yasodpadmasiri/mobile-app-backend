            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input data-target="#form-validation" class="show-code input input--switch border" type="checkbox">
                    </div>
                </div>
                <div class="p-5" id="form-validation">
                    <div class="preview">
                        <form class="validate-form">
                            ...
                            <div class="input-form mt-3">
                                ...
                                <input type="number" name="age" class="input w-full border mt-2" placeholder="21" maxlength="3" required>
                            </div>
                            <div class="input-form mt-3">
                                <label class="flex flex-col sm:flex-row">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-form-validation" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
                            <pre class="source-preview" id="copy-form-validation">
