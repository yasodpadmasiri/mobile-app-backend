        ...
        <div class="col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <div class="p-5" id="basic-datepicker">
                    <div class="preview">
                        <input class="datepicker input w-56 border block mx-auto" data-single-mode="true">
                    </div>
                    <div class="source-code hidden">
                        <button data-target="#copy-basic-datepicker" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="input-group-datepicker">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-input-group-datepicker" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
        ...
        <div class="col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <div class="p-5" id="daterangepicker">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-daterangepicker" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5" id="modal-datepicker">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-modal-datepicker" class="copy-code button button--sm border flex items-center text-gray-700 dark:border-dark-5 dark:text-gray-300">
                            <i data-feather="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto h-64 mt-3">
