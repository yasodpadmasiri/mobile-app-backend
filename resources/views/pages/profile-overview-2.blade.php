            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box col-span-12">
                    <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <button data-carousel="new-products" data-target="prev" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300 mr-2">
                            <i data-feather="chevron-left" class="w-4 h-4"></i>
                        </button>
                        <button data-carousel="new-products" data-target="next" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300">
                            ...
                            <div class="px-5">
                                <div class="flex flex-col lg:flex-row items-center pb-5">
                                    ...
                                    <div class="w-full lg:w-auto mt-6 lg:mt-0 pt-4 lg:pt-0 flex-1 flex items-center justify-center px-5 border-t lg:border-t-0 border-gray-200 dark:border-dark-5">
                                        <div class="text-center rounded-md w-20 py-3">
                                            <div class="font-semibold text-theme-1 dark:text-theme-10 text-lg">{{ $faker['totals'][0] }}</div>
                                            <div class="text-gray-600">Orders</div>
                                        </div>
                                        <div class="text-center rounded-md w-20 py-3">
                                            <div class="font-semibold text-theme-1 dark:text-theme-10 text-lg">{{ $faker['totals'][1] }}k</div>
                                            <div class="text-gray-600">Purchases</div>
                                        </div>
                                        <div class="text-center rounded-md w-20 py-3">
                                            <div class="font-semibold text-theme-1 dark:text-theme-10 text-lg">{{ $faker['totals'][0] }}</div>
                ...
                <div class="intro-y box col-span-12">
                    <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <button data-carousel="new-authors" data-target="prev" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300 mr-2">
                            <i data-feather="chevron-left" class="w-4 h-4"></i>
                        </button>
                        <button data-carousel="new-authors" data-target="next" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300">
                            <i data-feather="chevron-right" class="w-4 h-4"></i>
                        </button>
                    </div>
                        ...
                        @foreach (array_slice($fakers, 0, 5) as $faker)
                            <div class="px-5">
                                ...
                                <div class="flex flex-col sm:flex-row items-center border-t border-gray-200 dark:border-dark-5 pt-5">
                                    ...
                                    <div class="flex sm:ml-auto mt-5 sm:mt-0">
                                        <button class="button w-20 justify-center block bg-gray-200 dark:bg-dark-5 dark:text-gray-300 text-gray-600 ml-auto">Message</button>
                                        <button class="button w-20 justify-center block bg-gray-200 dark:bg-dark-5 dark:text-gray-300 text-gray-600 ml-2">Profile</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
