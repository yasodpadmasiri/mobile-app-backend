...
@section('subhead')
    <title>Authors List - Blog</title>
@endsection

@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Authors List</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <a href="javascript:;" data-toggle="modal" data-target="#header-footer-modal-preview" class="button text-white bg-theme-1 shadow-md mr-2">Add New Authors</a>
                                    ...
                                    <div class="modal" id="delete-confirmation-modal-{{$row->id}}">
                                        <div class="modal__content">
                                            ...
                                            <div class="px-5 pb-8 text-center">
                                                ...
                                                <a href="{{url('deleteAuthor')}}/{{$row->id}}" class="button w-24 bg-theme-6 text-white">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
        ...
        <div class="intro-y col-span-3 flex flex-wrap sm:flex-row sm:flex-no-wrap items-right">
            <p><?php if ($author->firstItem() != null) { ?> Showing {{ $author->firstItem() }} to {{ $author->lastItem() }} of {{ $author->total() }} entries <?php }?></p>
        </div>
    </div>   
