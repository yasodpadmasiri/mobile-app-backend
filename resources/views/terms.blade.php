...
<body>
        ...
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h1 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1">Policy & Terms</h1>
            </div>
        </div>
    </section>
    <section class="mbr-section content4 cid-qvbjfGj2Ze" id="content4-7x" data-rv-view="8339">
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h2 class="align-center pb-3 mbr-fonts-style display-5">DROP-DEAD EASY BOOTSTRAP BLOG</h2>
                    <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-7"><em>By John Smith posted July 30, 2016</em></h3> </div>
            </div>
        </div>
    </section>
