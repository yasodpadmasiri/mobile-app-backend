...
class SiteController extends Controller
{
    public function sendTest(){
        \Helpers::sendNotification("dKqyoyoBSNSeQ2aApYISiB:APA91bGS3OO7fjgSCt1hkkrjrgcI50ys1-xYmcXjUvyQzt-OoVI9XYcPTA7KLN5BHy7GcRCFORzz9RW2HfVk-Q3KtFuOuLSFBm6T6QQGcLndRt2uFSte7zjpkOc3y7A2fk_G5ym0K7Am",'New blog is created.','New Blog',"dKqyoyoBSNSeQ2aApYISiB:APA91bGS3OO7fjgSCt1hkkrjrgcI50ys1-xYmcXjUvyQzt-OoVI9XYcPTA7KLN5BHy7GcRCFORzz9RW2HfVk-Q3KtFuOuLSFBm6T6QQGcLndRt2uFSte7zjpkOc3y7A2fk_G5ym0K7Am");
        return "Notifications sent";
    }
    public function privacy($layout = 'side-menu', $theme = 'light')
    {
    ...
    public function terms($layout = 'side-menu', $theme = 'light')
    {
        return view('terms', [
            'theme' => $theme,
            'page_name' => 'terms',
    ...
    public function about($layout = 'side-menu', $theme = 'light')
    {
        return view('about', [
            'theme' => $theme,
            'page_name' => 'terms',
    ...
    public function join($layout = 'side-menu', $theme = 'light')
    {
        return view('join', [
            'theme' => $theme,
            'page_name' => 'terms',
    ...
    public function contact($layout = 'side-menu', $theme = 'light')
    {
        return view('contact', [
            'theme' => $theme,
            'page_name' => 'terms',
    ...
    public function advertise($layout = 'side-menu', $theme = 'light')
    {
    ...
    public function sideMenu()
    {
        return [
            ...
            'App Settings' => [
                'icon' => 'edit',
                'page_name' => 'app-setting',
                'title' => 'App Settings',
                'sub_menu' => [
                    'global-setting' => [
                        'icon' => '',
                        'layout' => 'side-menu',
                        'page_name' => 'global-setting',
                        'title' => 'Global Setting'
                    ],
                    'localisation' => [
                        'icon' => '',
                        'layout' => 'side-menu',
                        'page_name' => 'localisation',
                        'title' => 'Localisation'
                    ],
                    'social-authentication' => [
                        'icon' => '',
                        'layout' => 'side-menu',
                        'page_name' => 'social-authentication',
                        'title' => 'Social Authentication'
                    ],
                    'push-notification' => [
                        'icon' => '',
                        'layout' => 'side-menu',
                        'page_name' => 'push-notification',
